...
export const resumeIntroduction = [
  'C#/.NET 기반 Windows 응용프로그램을 중심으로 성능 최적화, 생산 시스템 연동, 검사 데이터 관리 기능을 개발해 왔습니다. 단순 운영 대응보다 사용자가 겪는 지연, 반복 장애, 기능 제약을 코드 구조와 처리 흐름 개선으로 해결하는 데 강점이 있습니다.',
...
export const resumeExperiences: ResumeExperience[] = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        keywords: ['C#', '.NET Framework', 'SECS/GEM', 'Refactoring'],
