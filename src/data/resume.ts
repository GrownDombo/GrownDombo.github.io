...
export const resumeIntroduction = [
  ...
  '안정적인 구조와 최적화된 성능을 함께 고려한 개발을 중요하게 생각하며, 자료구조, 패턴, 알고리즘을 중심으로 역량을 꾸준히 쌓아 왔습니다. 그 과정에서 이슈 발생률을 약 70% 줄이고, 데이터 처리 속도를 약 99% 향상시킨 경험이 있습니다.',
...
export const resumeExperiences: ResumeExperience[] = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        metrics: [
          '2D 좌표 기반 ROI 겹침 판별 처리 시간 단축: 6분 20초 → 3초, 약 99% 개선',
