...
export const resumeIntroduction = [
  ...
  '개인 프로젝트에서는 반복 작업 자동화와 성능 검증 도구 구현에 집중하고 있습니다. Excel 자동화 도구로 조건별 강조 표시와 통계 산출 흐름을 정리했고, C++ 기반 CPU/Memory 부하 테스트 도구로 성능 측정과 결과 수집 구조를 구현했습니다. 실무에서 마주치는 문제를 작은 도구로 분리해 검증하고, GitHub에 공개하며 코드 구조와 사용 흐름을 꾸준히 다듬고 있습니다.',
];
