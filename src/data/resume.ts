...
export const resumeIntroduction = [
  'C#/.NET 기반 Windows 응용프로그램을 중심으로 성능 최적화, 외부 시스템 연동, 데이터 관리 기능을 개발해 왔습니다. 단순 운영 대응보다 사용자가 겪는 지연, 반복 이슈, 기능 제약을 코드 구조와 처리 흐름 개선으로 해결하는 데 강점이 있습니다.',
  '대표적으로 대용량 좌표 매칭 시간을 6분 22초에서 3.5초로 단축했고, 외부 시스템 연동 구조 정리로 이슈 관리 시스템 등록 건수를 약 70% 줄였습니다. 단축키 지원 범위 확장, 원격 공유 폴더 I/O 병목 해소, 폴리곤 기반 결과 영역 가시화처럼 사용자가 바로 체감할 수 있는 개선도 함께 수행했습니다.',
